...
#include "../../untitled/serialthread.h"
...
QT_MOC_LITERAL(1, 13, 14), // "recved_package"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 3) // "bta"

    },
    "SerialThread\0recved_package\0\0bta"
};
...
void SerialThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { int _r = _t->recved_package((*reinterpret_cast< QByteArray(*)>(_a[1])));
        ...
        {
            typedef int (SerialThread::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialThread::recved_package)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
int SerialThread::recved_package(QByteArray _t1)
{
    int _t0 = int();
